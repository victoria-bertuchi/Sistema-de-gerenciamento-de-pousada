...
export interface IUsuario extends Document{
    ...
    senha: string;
    cargo: string;
    nivelAcesso: 'administrador' | 'funcionario';
}
...
const UsuarioSchema: Schema = new Schema ({
    ...
    cargo: { type: String, required: [true, 'O cargo/função é obrigatório'], trim: true },
    nivelAcesso: { 
        type: String, 
        enum: ['administrador', 'funcionario'], 
        required: [true, 'O nível de acesso deve ser administrador ou funcionário'] 
    }
}, {
